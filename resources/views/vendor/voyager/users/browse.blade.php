...
@section('page_header')
    <div class="container-fluid">
        ...
        <a class="btn btn-warning" href="/admin/excel">Export Excel</a>
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    @endforeach
                                    <th>
                                        <a href="?sort_order=asc&order_by=data.website">
                                           Experience
                                        </a>
                                    </th>
                                    <th>
                                        <a href="?sort_order=desc&order_by=instagram">
                                            instagram
                                        </a></th>
                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        @endforeach
                                        <td>{{json_decode($data->data)->experience??"null"}}</td>
                                        <td><a href="{{json_decode($data->data)->instagram??"null"}}" target="_blank">
                                                مشاهده
                                            </a></td>
